      ...
      <div class="py-2 inline-block min-w-full sm:px-6 lg:px-8">
        <div class="overflow-hidden">
          ...
          <table class="min-w-full">
            <thead class="bg-none underline border-b">
              <tr>
            ...
            <tbody>
              ...
              <tr class="bg-white border-b transition duration-300 ease-in-out hover:bg-gray-100">
                ...
                <td class="px-6 py-4 whitespace-nowrap text-sm font-medium text-gray-900 "><a href="{{URL('edit-admin/'.$user->id)}}"> <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="w-6 h-6">
                      <path stroke-linecap="round" stroke-linejoin="round" d="M16.862 4.487l1.687-1.688a1.875 1.875 0 112.652 2.652L6.832 19.82a4.5 4.5 0 01-1.897 1.13l-2.685.8.8-2.685a4.5 4.5 0 011.13-1.897L16.863 4.487zm0 0L19.5 7.125" />
                    </svg></a> </td>
                <td class="px-6 py-4 whitespace-nowrap text-sm font-medium text-gray-900"><a href="{{URL('delete-admin/'.$user->id)}}"><svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="w-6 h-6">
